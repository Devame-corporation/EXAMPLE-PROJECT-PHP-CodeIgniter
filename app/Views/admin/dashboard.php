...
<link href="./assets/admin/css/loader.css" rel="stylesheet" type="text/css" />
...
<link href="./assets/admin/css/dashboard/dash_1.css" rel="stylesheet" type="text/css" class="dashboard-analytics" />
<!-- END PAGE LEVEL PLUGINS/CUSTOM STYLES -->
</head>

<body class="dashboard-analytics">
    <?php include("_inc_nav.php") ?>
    <div class="main-container" id="container">

        <div class="overlay"></div>
        <div class="search-overlay"></div>

        <?php include("_inc_sidebar.php") ?>
    ...
    <script src="./assets/admin/js/dashboard/dash_1.js"></script>
    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
    <script>
        <?php
        //print_r($dataTotalUsers);
        print "var spark2 = {
                        chart: {
                            id: 'total-users',
                            group: 'sparks1',
        ...
        foreach ($dataTotalUsers as $data) {
            print $data . ",";
        }
